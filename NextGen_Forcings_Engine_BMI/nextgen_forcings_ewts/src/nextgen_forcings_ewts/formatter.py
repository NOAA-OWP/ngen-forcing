...
# Define PERFORMANCE logging level
PERFORMANCE_LEVEL_NUM = 15  # Between DEBUG (10) and INFO (20)
logging.PERFORMANCE = PERFORMANCE_LEVEL_NUM  # <-- add as logging constant
logging.addLevelName(PERFORMANCE_LEVEL_NUM, "PERFORMANCE")

# Optional: add a convenience method to logger objects
def performance(self, message, *args, **kwargs):
    if self.isEnabledFor(logging.PERFORMANCE):
        self._log(logging.PERFORMANCE, message, args, **kwargs)
