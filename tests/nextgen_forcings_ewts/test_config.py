...
import logging
from nextgen_forcings_ewts.config import configure_logging, translate_ngwpc_log_level
from nextgen_forcings_ewts.constants import MODULE_NAME, EV_EWTS_LOGGING
...
def test_ewts_logger_matrix(clean_ewts_env, monkeypatch, capsys, env_value, expected_enabled, level_input, expected_level):
    ...
    monkeypatch.setenv("FORCING_LOGLEVEL", level_input)
