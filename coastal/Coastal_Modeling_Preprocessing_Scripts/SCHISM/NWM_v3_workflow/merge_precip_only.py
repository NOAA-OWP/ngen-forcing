...
outPath = pathlib.Path('./NWMv3_Atlantic/')
...
source = nc.Dataset(filePath/'source2.nc')
...
if (filePath/'source_precip_only.nc').exists():
    os.remove(filePath/'source_precip_only.nc')
