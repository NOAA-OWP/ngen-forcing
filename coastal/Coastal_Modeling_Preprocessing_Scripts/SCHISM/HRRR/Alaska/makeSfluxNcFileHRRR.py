...
path = '/scratch2/NCEPDEV/ohd/Hassan.Mashriqui/schism/Alaska_tide_30days_base/'
outdir = '/scratch2/NCEPDEV/ohd/Jason.Ducker/HRRR_SCHISM/SCHISM_2020'
cppFile = os.path.join(path,'hgrid.cpp')
llFile = os.path.join(path,'hgrid.gr3')
outfile = os.path.join(outdir,'sflux2sourceInput.nc')
polygon_enclosure = '/scratch2/NCEPDEV/ohd/Jason.Ducker/extract4dflow-master/Extract_DFlowFM_Input_Files/Polygon_enclosure_files/AK_Enclosure.pol'
...
hrrr_file = '/scratch2/NCEPDEV/ohd/Jason.Ducker/HRRR_SCHISM/Alaska_HRRR/hrrr.20200530/hrrr.t00z.wrfprsf01.ak.grib2'
