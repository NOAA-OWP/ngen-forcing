...
FVCOM_dir = "/scratch2/NCEPDEV/ohd/Jason.Ducker/Lake_Superior/FVCOM/"
gridFile = "/scratch2/NCEPDEV/ohd/NG_Coastal_Model_Setups/Lake_Superior/SCHISM/hgrid.gr3"
outFile = '/scratch2/NCEPDEV/ohd/NG_Coastal_Model_Setups/Lake_Superior/SCHISM/elev2Dth.nc'
#convFile = path+'Data/domainFiles/atl/final/atlBoundNodes_conversion_factor.txt'
start_time = datetime.strptime("2019-09-01 00:00", '%Y-%m-%d %H:%M')
end_time = datetime.strptime("2019-11-01 00:00", '%Y-%m-%d %H:%M')
########################################################################################
