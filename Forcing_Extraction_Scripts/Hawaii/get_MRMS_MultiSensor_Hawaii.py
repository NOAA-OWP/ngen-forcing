...
def main(args):
    ...
    pid = os.getpid()
    lockFile = outDir + "/GET_MRMS_MultiSensor_HI.lock"
    ...
    if os.path.isfile(lockFile):
        ...
        print("ERROR: Another MRMS Multisensor Hawaii Fetch Program Running. PID: " + pid + ". Please remove lockfile before attempting to execute another file extraction. Exiting script")
        sys.exit(1)
    else:
