...
class ngen_AORC_model():
    ...
    def run(self, model: dict, dt: int, date, base_url, aorc_beg, aorc_end, aorc_new_end, ERRDAP_data, AORC_data_pathway, AORC_files, AORC_met_vars, scale_factor, add_offset, missing_value):
        """
